...
public class ANTLRv4TokenTypes {
    ...
    public static final TokenSet KEYWORDS =
        createTokenSet(
            ANTLRv4Language.INSTANCE,
            ANTLRv4Lexer.PROTECTED, ANTLRv4Lexer.IMPORT, ANTLRv4Lexer.CATCH,
            ANTLRv4Lexer.PRIVATE, ANTLRv4Lexer.PUBLIC, ANTLRv4Lexer.FINALLY,
            ANTLRv4Lexer.RETURNS, ANTLRv4Lexer.THROWS, ANTLRv4Lexer.LOCALS
        );
    
    public static final TokenSet SPECIAL_KEYWORD =
        createTokenSet(
            ANTLRv4Language.INSTANCE,
            ANTLRv4Lexer.LEXER,
            ANTLRv4Lexer.FRAGMENT,
            ANTLRv4Lexer.MODE,
            ANTLRv4Lexer.GRAMMAR,
            ANTLRv4Lexer.PARSER
        );
